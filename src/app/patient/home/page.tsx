  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] gap-4">
      <div className="flex items-center justify-between shrink-0">
        <div>
          <p className="text-xs font-mono uppercase tracking-widest text-dark/50 mb-0.5">Patient Dashboard</p>
          <h1 className="text-2xl font-bold text-ink">Hello{userName?.trim() ? `, ${userName}` : ''}</h1>
        </div>
        <div className="flex items-center gap-2 bg-paper border border-primary/20 rounded-lg px-3 py-2">
          <span className="text-xs text-dark/60 font-mono">Wallet</span>
          <span className="text-sm font-bold text-ink font-mono">₹0.00</span>
        </div>
      </div>
      ...
      <div className="flex-1 relative rounded-xl overflow-hidden border border-primary/20 shadow-warm min-h-[300px]">
        ...
        <div className="absolute top-3 left-3 z-10 bg-paper/95 border border-primary/20 rounded-lg px-3 py-2 shadow-warm flex items-center gap-2">
          ...
          <span className="text-xs font-mono text-ink/80 truncate max-w-[200px]">{locationName}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3 shrink-0">
        ...
        >
          ...
          <div>
            <h3 className="font-bold text-base leading-tight">EMERGENCY SOS</h3>
            <p className="text-red-200 text-xs mt-0.5">Request critical response</p>
          </div>
        </Link>
        ...
        >
          ...
          <div>
            <h3 className="font-bold text-base text-ink">Book Now</h3>
            <p className="text-dark text-xs mt-0.5">Medical transfer</p>
          </div>
        </Link>
        ...
        <button className="col-span-3 md:col-span-1 bg-paper border border-primary/20 rounded-xl p-5 flex items-center gap-4 opacity-50 cursor-not-allowed">
          ...
          <div className="text-left">
            <h3 className="font-bold text-base text-ink">Schedule</h3>
            <p className="text-dark text-xs mt-0.5">Coming soon</p>
          </div>
        </button>
      </div>
    </div>
